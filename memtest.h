...
#define PAGE_DESCRIPTORS_PER_PAGE (PAGE_SIZE/8)
#define MEGABYTE   0x100000LU
#define GIGABYTE  0x40000000UL

#define LARGE_PAGE_SIZE (2*MEGABYTE)
#define MEMORY_PER_DIRECTORY_ENTRY   GIGABYTE

#define PROGRAM_BASE_ADDRESS   (4*MEGABYTE)
#define RESERVED_FOR_PAGE_TABLE (9*MEGABYTE)
#define OFFSET_FOR_NEXT_PASS     (16*MEGABYTE)
#define TEST_AREA_START_VIRTUAL  (16*MEGABYTE)
#define TEST_AREA_END_VIRTUAL  (3*GIGABYTE)
#define PAGE_TABLE_BASE_ADDRESS  (PROGRAM_BASE_ADDRESS + MEGABYTE)
#define INITIAL_PROGRAM_LOCATION_PHYS (4*MEGABYTE)

#define INITIAL_MAPPED_VIRTUAL_MEMORY (32*MEGABYTE)
